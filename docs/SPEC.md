...
- **Medium**: G-1 status double-meaning, G-3 title_requirelist fragmentation, G-4 fuzzy dedup unused, G-33 location_blocklist retro. (~~G-10/G-11 SKILL prompts~~, ~~G-15 unknown-tier~~, ~~G-18 archetype~~, ~~G-21 double-write~~, ~~G-22 split property API~~ закрыты 2026-05-04.)
