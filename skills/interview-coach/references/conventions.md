...
**Флоу:** screening · manager. Пишется в **storybank**, не в конспекте.
...
**How to apply.** Правка делается в самой истории (`28`), а не в обвязке конспекта. Формулировка, поправленная только в подводке или в дочитке, живёт до следующего раунда: истории транслюдируются, обвязка пишется заново каждый раз — и на новом конспекте кандидат снова услышит из своего же рта голую поставку.

↩ История: `decisions-log.md` § 15a.

### Сравнение не уменьшает собственную цифру · 15b

**Флоу:** screening · manager. Пишется в **storybank**.
