...
| `audit` | Run the round-file detectors before any readiness claim | 9-detector report: missing source, unstarted topics, open debts, deleted debt ids, formula without derivation, missing spoken line, topic absent from the cheat sheet, forbidden section for this `kind`, write inside the T−4h freeze |
